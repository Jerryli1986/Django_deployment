...
def index(request):
    ...
    return render(request, 'neo_nodes_v1/index.html', context)
...
def create(request):
    ...
    return render(request, 'neo_nodes_v1/create.html', context)



def read(request):
    context = {'key': 'Read page!'}
    return render(request, 'neo_nodes_v1/read.html', context)